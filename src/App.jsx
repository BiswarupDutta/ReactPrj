      ...
      <main>
        ...
        <section id="examples">
          ...
          <menu>
            ...
            <TabButton isSeleted={selectedTopic === 'jsx'} onSelect ={() => handleSelect('jsx')}>JSX</TabButton>
            <TabButton isSeleted={selectedTopic === 'props'} onSelect ={() => handleSelect('props')}>Props</TabButton>
